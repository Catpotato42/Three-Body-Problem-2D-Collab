...
Position variables are in pixels from the top left of the screen (positive down and right), which has its width and height (not dynamic so don't go resizing the window after the first screen) printed at the top left when entering initial values.
